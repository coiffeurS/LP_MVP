...
const Footer = () => {
  const handleWhatsAppClick = () => {
    window.open("https://wa.me/5511999999999?text=Olá! Gostaria de saber mais sobre o coiffeurS.", "_blank");
  };
        ...
        <div className="text-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xl text-primary-foreground/80 max-w-2xl mx-auto">
              Transformando barbearias em negócios digitais modernos e eficientes.
            </p>
          </div>
          ...
          <div className="pt-8 border-t border-primary-foreground/20">
            <p className="text-primary-foreground/60">
              © 2024 coiffeurS. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </div>
